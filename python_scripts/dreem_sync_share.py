...
os.environ['LOCAL_PATH'] = "/mnt/ceph/users/nshah/Sleep_study-neelay/SubjectsData/dreem/aws_data/"
...
command = [
    'python', '/mnt/ceph/users/nshah/Simons-sleep-DM/python_scripts/dreem_hypno_share.py',
]
